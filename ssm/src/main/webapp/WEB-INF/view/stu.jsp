...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="gread" id = "txt_search_roleid">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>所属年级：</td>
								<td><select class="form-control" name="gread" id = "gread">
									<option value="">---请选择---</option>
									<option value="一年级">一年级</option>
									<option value="二年级">二年级</option>
									<option value="三年级">三年级</option>
							...
							<tr>
								...
								<td>
									<input name = "entrytime" id = "entrytime" class="laydate-icon form-control layer-date" >
								</td>
							</tr>
	...
	<!-- 新增课程对话框 -->
	<div class="modal fade" id="modal_course_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_course" method="post" action="reserveKc.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名称：</td>
								...
								<td>课程编码</td>
								<td>
									<input type = "text" id = "codec" name = "codec"
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addkc").click(function(){
	    		$("#form_course").resetForm();
	    		$('#modal_course_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_course_edit').modal('show');
	        });
